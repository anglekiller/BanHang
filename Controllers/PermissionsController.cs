...
namespace BanHang.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PermissionId,PermissionName,Detail")] Permission permission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("PermissionId,PermissionName,Detail")] Permission permission)
        {
